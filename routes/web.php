 ...
 * Vue cours
 */
// route pour l'affichage de la page des cours
Route::get('/courses', [App\Http\Controllers\CoursesController::class, 'courses'])->name('courses.index');
Route::get('/courses/{slug}', [App\Http\Controllers\CoursesController::class, 'course'])->name('courses.show');
...
Route::get('/instructor/courses/publish/{id}', [App\Http\Controllers\InstructorController::class, 'publish'])->name('instructor.publish');
